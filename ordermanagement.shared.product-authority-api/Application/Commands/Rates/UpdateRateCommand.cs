...
{
    public class UpdateRateCommand : CommandEvent, IRequest
    {
        ...
        public UpdateRateCommand(string productKey, string offeringKey, string rateKey, DateTime orderStartDate, DateTime orderEndDate, long rateClassificationId, decimal? unitRetailAmount, decimal? commissionAmount,
